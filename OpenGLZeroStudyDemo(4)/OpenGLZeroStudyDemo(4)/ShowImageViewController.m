...
-(void)loadVertex{
   ...
   int a =  glGetUniformLocation(self.shader.program, "sam2DR");
    ...
    self.textureUnit1  = [TextureUnit new];
    [self.textureUnit1 setImage:image IntoTextureUnit:GL_TEXTURE1 andConfigTextureUnit:nil];
     a =  glGetUniformLocation(self.shader.program, "sam2D");
    [self.textureUnit1 bindtextureUnitLocationAndShaderUniformSamplerLocation:a];
