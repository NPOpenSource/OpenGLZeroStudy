...
#import "MoreObjectViewController.h"

@interface MoreObjectViewController ()

@property (nonatomic ,strong) UIViewController * tapVc;

@end

@implementation MoreObjectViewController


-(NSArray *)buttonTitles{
    return @[@[@"效果一",@"EffectOneViewController"],@[@"效果二",@"EffectTwoViewController"],@[@"太阳地球月亮",@"SunViewController"]];
}
