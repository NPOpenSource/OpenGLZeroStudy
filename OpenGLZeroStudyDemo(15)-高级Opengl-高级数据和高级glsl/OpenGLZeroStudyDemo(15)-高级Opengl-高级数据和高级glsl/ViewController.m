...
//
//  Created by glodon on 2019/9/11.
...
-(NSArray *)buttonTitles{
    return @[@[@"默认渲染方式",@"DefaultViewController"],@[@"高级数据",@"HeightDataViewController"],@[@"高级数据填充方式2",@"HeightDataSubViewController"],@[@"glsl-Point",@"GLPointViewController"],@[@"glsl-Coord",@"GLFragCoordViewController"]];
}
