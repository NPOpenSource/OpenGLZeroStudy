//
//  VertexAttPostionViewController.m
...
#import "VertexAttPostionViewController.h"

@interface VertexAttPostionViewController ()

@end

@implementation VertexAttPostionViewController
#define VertexNum 6
