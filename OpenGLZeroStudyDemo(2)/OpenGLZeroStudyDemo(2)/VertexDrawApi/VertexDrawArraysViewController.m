//
//  VertexDrawArraysViewController.m
...
#import "VertexDrawArraysViewController.h"

@interface VertexDrawArraysViewController ()

@end

@implementation VertexDrawArraysViewController
#define VertexNum 6
-(void)loadVertex{
