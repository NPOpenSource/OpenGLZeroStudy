//
//  VeertexThreeDimViewController.m
...
#import "VeertexThreeDimViewController.h"


@interface VeertexThreeDimViewController ()

@end

@implementation VeertexThreeDimViewController
#define VertexNum 3
-(void)loadVertex{
