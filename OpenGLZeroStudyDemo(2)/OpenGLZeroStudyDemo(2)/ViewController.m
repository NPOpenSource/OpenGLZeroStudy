...
#import "VertexCreateViewController.h"
...
-(NSArray *)buttonTitles{
    return @[@[@"顶点创建",@"VertexCreateViewController"],@[@"点模式绘制",@"VertexDrawModeController"],@[@"顶点属性",@"VertexAttViewController"],@[@"绘制api",@"VertexDrawAPIViewController"]];
}
