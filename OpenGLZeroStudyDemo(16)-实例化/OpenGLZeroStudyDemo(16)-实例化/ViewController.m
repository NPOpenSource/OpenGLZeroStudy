...
-(NSArray *)buttonTitles{
    return @[@[@"默认渲染方式",@"DefaultViewController"],@[@"实例化demo1",@"InstanceIDViewController"],@[@"实例化demo2",@"DivisorViewController"],@[@"实例化demo3",@"Divisor2ViewController"],@[@"glsl-Coord",@"GLFragCoordViewController"]];
}
