...
-(void)loadVertex{
    ...
    glUniform3fv(self.bindObject->uniforms[LightUniformLocationLightAmbient], 1, &light.ambient);
    glUniform3fv(self.bindObject->uniforms[LightUniformLocationLightsSpecular], 1, &light.specular);
    glUniform3fv(self.bindObject->uniforms[LightUniformLocationLightDiffuse], 1, &light.diffuse);
